...
def create_window(room_id, group_id):
    ...
    combo_room = sg.Combo(room_str_list, default_value, key='room', readonly=True)
    ...
    combo_group = sg.Combo(group_str_list, default_value, key='group', readonly=True)
    ...
    layout = [
        [sg.Text('Sala: '), combo_room, combo_group, sg.Button('Refresh', key='refresh')],
        [canvas1],
        [canvas2],
